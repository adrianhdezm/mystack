...
8. Update project documentation using [documentation-updates.md](../../shared/references/documentation-updates.md) with these specifics:
   ...
   - **New convention**: `docs/conventions/testing.md` — seed with patterns from [testing-conventions.md](../../shared/references/testing-conventions.md): directory-based type inference, `__tests__/` co-location, `getTestDb` import pattern, and layer-specific testing guidance.
